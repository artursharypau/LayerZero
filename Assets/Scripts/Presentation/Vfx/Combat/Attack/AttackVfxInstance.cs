...
{
    internal sealed class AttackVfxInstance : MonoBehaviour, IVfxInstance
    {
        ...
        public void Play(Vector2 position, Quaternion rotation, Color? tint = null)
        {
            _renderer.color = tint ?? _defaultColor;
