...
namespace Characters.Enemy.States
{
    public class EnemyBattleState : EnemyState
    {
        ...
        public EnemyBattleState(StateMachine fsm, EnemyController controller)
            : base(fsm, controller, EnemyAnimatorHashProvider.Battle)
        {
        }
        ...
        public override void Enter()
        {
            ...
            _initialMoveAnimMultiplier = Anim.GetFloat(EnemyAnimatorHashProvider.BattleMoveAnimMultiplier);
            ...
            Anim.SetFloat(EnemyAnimatorHashProvider.BattleMoveAnimMultiplier, Controller.BattleMoveAnimMultiplier);
        }
        ...
        public override void Exit()
        {
            ...
            Anim.SetFloat(EnemyAnimatorHashProvider.BattleMoveAnimMultiplier, _initialMoveAnimMultiplier);
        }
